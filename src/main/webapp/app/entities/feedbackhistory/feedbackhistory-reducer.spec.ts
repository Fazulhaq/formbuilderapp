...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACKHISTORY actions', async () => {
      const expectedActions = [
        {

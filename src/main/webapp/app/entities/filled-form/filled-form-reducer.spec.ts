...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILLEDFORM_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILLEDFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILLEDFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILLEDFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILLEDFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILLEDFORM actions', async () => {
      const expectedActions = [
        {

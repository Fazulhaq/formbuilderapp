...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPTYFORM_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPTYFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPTYFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPTYFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPTYFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPTYFORM actions', async () => {
      const expectedActions = [
        {
